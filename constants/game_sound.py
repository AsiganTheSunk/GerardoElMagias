...
earth_spell_sound = mixer.Sound("resources/sound/spells/earth_shock_spell.wav")
earth_spell_sound.set_volume(0.1)

water_nova_sound = mixer.Sound("resources/sound/spells/earth_shock_spell.wav")
water_nova_sound.set_volume(0.1)
