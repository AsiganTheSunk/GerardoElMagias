...
def scripted_enemy(boss_level, animation_master):
    bosses = [
        ...
        Dragon(500, 575, "Dragon", 14, 214, 50, 20, 5, 11, 490, (screen_height - panel_height + 40), animation_master),
        Dragon(500, 555, "Dragon", 18, 244, 50, 24, 7, 12, 490, (screen_height - panel_height + 40), animation_master),
        Boss(500, 555, "The Boss", 22, 287, 50, 28, 9, 13, 490, (screen_height - panel_height + 40), animation_master),
