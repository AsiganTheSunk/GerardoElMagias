...
def scripted_enemy(boss_level, animation_master):
    bosses = [
        None,
        BanditChief(650, 475, "BanditChief", 10, 17, 10, 20, 0, 680, (screen_height - panel_height + 40), animation_master),
        Djinn(750, 400, "Djinn", 14, 0, 25, 10, 20, 680, (screen_height - panel_height + 40), animation_master),
        SmallDragon(730, 438, "SmallDragon", 18, 18, 7, 30, 12, 680, (screen_height - panel_height + 40), animation_master),
        Dragon(800, 352, "Dragon", 22, 20, 8, 30, 22, 680, (screen_height - panel_height + 40), animation_master),
        Demon(800, 365, "Demon", 26, 31, 12, 35, 18, 680, (screen_height - panel_height + 40), animation_master),
        Demon(600, 365, "Demon", 30, 41, 25, 40, 25, 680, (screen_height - panel_height + 40), animation_master)
    ]
