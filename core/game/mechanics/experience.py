...
class ExperienceSystem:
    @staticmethod
    def evaluate_kill(hero_player, target, damage_text_group):
        if not target.alive:
    ...
    @staticmethod
    def evaluate_group_kill(hero_player, target_list, pre_target_list, post_target_list, damage_text_group):
