...
class SoundMaster:
    def __init__(self):
        ...
        self.stage_selector_sound = StageSoundSelector(self.sounds)

        self.current_playing_sound = None
        self.previous_game_mode = None

    def set_stage_sounds(self, stage_name):
        self.stage_selector_sound.set_stage_sounds(stage_name)

    def get_stage_sounds(self):
        return self.stage_selector_sound.current_stage
    ...
    def background_sound_play(self, game_mode):
        background_stage_sound = self.stage_selector_sound.current_stage.background_sound
    ...
    def victory_sound_play(self, game_mode):
        victory_sound = self.stage_selector_sound.current_stage.victory_sound
        if game_mode is GameModes.VICTORY:
            self.stop_previous_sound(game_mode)
            self.update_play_sound(victory_sound)

    def defeat_sound_play(self, game_mode):
        defeat_sound = self.stage_selector_sound.current_stage.defeat_sound
    ...
    def boss_sound_play(self, game_mode):
        background_boss_music = self.stage_selector_sound.current_stage.background_boss_sound
